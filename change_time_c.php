                ...
                <div class="card-body">
                    <div class="table-responsive ">
                        <form action="change_time.php" method="POST">
                            ...
                            //     echo $cek_date_awal;
                            //     echo $cek_date_akhir;
                            $cek = mysqli_fetch_array(mysqli_query ($cnts,"SELECT * FROM target tg WHERE tg.tgl_akhir>'$cek_date_akhir'"));
                            echo "SELECT * FROM target tg WHERE tg.tgl_akhir>'$cek_date_akhir'";
                            // echo $cek['tgl_akhir'];
                            // }
                            // if($cek['tgl']!= ''){
                            if(isset($cek['tgl_akhir'])){
                                echo "ada";
                                // cek ada/tidak nya data
                                if(isset($_POST['dept_d']) and isset ($_POST['shift_s']) and isset ($_POST['star_day_star']) and isset ($_POST['end_day_end']) and isset ($_POST['tacktime'])
                                                           and isset ($_POST['tgl_old'])and isset ($_POST['tgl_edit'])and isset ($_POST['tgl_insert']) and isset ($_POST['tgl_akhir_insert']) ){
                            ...
                            }else if(!isset($cek['tgl_akhir'])){
                                echo "tidak ada";
                                if(isset($_POST['dept_d']) and isset ($_POST['shift_s']) and isset ($_POST['star_day_star']) and isset ($_POST['end_day_end']) and isset ($_POST['tacktime'])
                                                           and isset ($_POST['tgl_edit'])and isset ($_POST['tgl_insert']) and isset ($_POST['tgl_akhir_insert']) ){
                                    // terima data   
                                    $dept = $_POST['dept_d'];
                                    $shift = $_POST['shift_s'];
                                    $star_day_star = $_POST['star_day_star'];
